...
const galleryItems = [
  { id: 'art-1', title: "Transient Echoes", artist: "Maya V.", price: 12000, available: true, img: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?auto=format&fit=crop&q=80&w=1945" },
  { id: 'art-2', title: "Velvet Dawn", artist: "Julian K.", price: 8500, available: false, img: "https://images.unsplash.com/photo-1541963463532-d68292c34b19?auto=format&fit=crop&q=80&w=1976" },
  { id: 'art-3', title: "Obsidian Flow", artist: "Soma L.", price: 24000, available: true, img: "https://images.unsplash.com/photo-1549490349-8643362247b5?auto=format&fit=crop&q=80&w=1974" },
  { id: 'art-4', title: "Primal Surge", artist: "Erik B.", price: 18000, available: true, img: "https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?auto=format&fit=crop&q=80&w=1974" },
  { id: 'art-5', title: "Dusk Ritual", artist: "Lara M.", price: 31000, available: false, img: "https://images.unsplash.com/photo-1554188248-986adbb73be4?auto=format&fit=crop&q=80&w=2070" },
  { id: 'art-6', title: "Carbon Hue", artist: "Aris P.", price: 9500, available: true, img: "https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?auto=format&fit=crop&q=80&w=2072" },
];
...
const ArtPage: React.FC<ArtPageProps> = ({ onAddToCart }) => {
  ...
  const handleAddToCart = (art: typeof galleryItems[0]) => {
    onAddToCart({
      id: art.id,
      name: art.title,
      notes: art.artist,
